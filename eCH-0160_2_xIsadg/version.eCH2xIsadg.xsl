	...
	<xsl:function name="arelda:checkXdate">
		...
		<xsl:element name="dates">
			<xsl:element name="fromDate">
				<xsl:value-of select="$date/arelda:von/arelda:datum"/>
			</xsl:element>
			<xsl:element name="toDate">
				<xsl:value-of select="$date/arelda:bis/arelda:datum"/>
			</xsl:element>
		</xsl:element>
	</xsl:function>
	<!-- Function toXdate -->
		...
		<xsl:element name="identity">
			...
			<xsl:choose>
				<xsl:when test="arelda:entstehungszeitraum">
					<xsl:value-of select="arelda:checkXdate(arelda:entstehungszeitraum)"/>
				</xsl:when>
